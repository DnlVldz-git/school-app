...
import Verify from "screens/private/verify";

const Tab = createBottomTabNavigator();
const AnimatedSvg = Animated.createAnimatedComponent(Svg);
const difference = 15;

const NoVerifiedTabs = () => {
  return (
    <Tab.Navigator
      initialRouteName="Verificate"
      screenOptions={() => ({
        headerShown: false,
      })}
        ...
        options={{
          ...
          tabBarIcon: ({ ref }) => (
            <Lottie
              ref={ref}
              loop={false}
              source={require("../assets/lottie/verify-account.json")}
              style={styles.icon}
            />
          ),
        }}
