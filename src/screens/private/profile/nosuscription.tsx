    ...
    <Container style={styles.container}>
      ...
      <Content contentContainerStyle={styles.content}>
        <VStack level="1" mh={16} border={16} padding={24}>
          ...
          <Image marginBottom={27} marginTop={30} source={Images.stars}
            /* @ts-ignore */
            style={styles.susbs}
          />
          <Text category="h8" marginBottom={3}>
          Suscribete algún plan para acceder a las clases y materiales que se tienen preparado para ti!!
          </Text>
        </VStack>
            ...
            <Carousel
                ...
                return (
                    ...
                    <HStack wrap mt={10} mb={12}>
                        ...
                        return (
                            <HStack key={i} itemsCenter style={{width: 80}} mb={12}>
                            <View
                                style={{
                            ...
                            <Image marginBottom={50} marginTop={30} source={Images.premium}
                                /* @ts-ignore */
                                style={styles.image}
                            />
                            </HStack>
...
const DATA = [
  {
    ...
    pay: 'MXN 800',
    data: [
      {title: '3 clases a la semana', color: '#5784E8'},
    ],
  },
  {
    ...
    pay: 'MXN 1,200',
    data: [
      {title: '4 clases a la semana', color: '#FFDE70'},
    ],
  },
  {
    ...
    pay: 'MXN 1,600',
    data: [
      {title: '5 clases a la semana', color: '#E5CABF'},
    ],
  },
];
